...
For older pre-Nomad reductions, both `v1.1.0` and `v1.0.1` include multiple updates/fixes compared to the legacy code from the original pySAred author. Yet, we always recommend the use of the latest release.
